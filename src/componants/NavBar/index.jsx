...
const NavBarCmp = () => {
  ...
  const ActionButtons = [
    { text: "Sign In", func: () => navigate("/") },
    { text: "Sign Up", func: () => navigate("/signup") },
  ];
  const settings = [
    { text: "Profile", func: () => handleClickOpen() },
    { text: "Logout", func: () => UserLogOut() },
  ];
  return (
    <>
        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            <Box
              sx={{
                flexGrow: 0,
                display: { xs: "none", md: "flex", float: "right" },
              }}
            >
              {!bool ? (
