...
const SignUpCmp = () => {
  ...
  const { statement, UserSelection } = useSelector(
        ...
        ? createUserWithEmailAndPassword(auth, Email, Password)
            ...
            .catch((erorr) => {
              ...
              dispatch(
                LoginError({
                  bool: true,
                  statement: ["Please Enter Your correct "],
                })
              );
            })
        : dispatch(
            LoginError({
              ...
              statement: [
                ...
                "Please enter Min 3 digits in username and max 13 digits",
              ],
            })
          )
              ...
              <Grid container spacing={1}>
                <Grid item xs={12}>
                  <InputCmp
                    ...
                    helper={
                      statement[1] ? statement[1] : `${statement[0]} UserName`
                    }
                    value={UserName}
                    type="text"
                  />
